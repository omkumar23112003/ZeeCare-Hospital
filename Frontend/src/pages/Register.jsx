...
const Register = () => {
  ...
  const handleRegister = async(e)=>{
    ...
    try {
      const response = await axios.post(
        `${import.meta.env.VITE_SERVER_URL}/api/v1/user/patient/register`,
      ...
      navigateTo("/"); // Use the navigate function here
    } catch (error) {
  ...
  return (
    <div className='container form-component register-form'>
      ...
      <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Harum vitae aliquam numquam enim suscipit ad.</p>
