    ...
    const fetchAppointments = async()=>{
      try {
        const {data} = await axios.get(
          `${import.meta.env.VITE_SERVER_URL}/api/v1/appointment/getAll`, 
  ...
  const handleUpdateStatus = async(appointmentId, status)=>{
    try {
      const {data} = await axios.put(
        `${import.meta.env.VITE_SERVER_URL}/api/v1/appointment/update/${appointmentId}`,
        {status},
        {withCredentials: true}
      );
        ...
        <div className="banner">
          ...
          <div className="firstBox">
            ...
            <div className="content">
              ...
              <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Atque consectetur error, eligendi dolore molestiae repellendus dolore</p>
            </div>
          </div>
